...
class LocalNotificationsService {
  ...
  final _androidInitializationSettings = const AndroidInitializationSettings('@mipmap/launcher_icon');//icon display in foreground mode
  ...
  Future<void> init() async {
    ...
    await _flutterLocalNotificationsPlugin.initialize(initializationSettings,
      ...
      NavigatorService.pushNamed('/map');
    });
  ...
  Future<void> showNotification(
    ...
    AndroidNotificationDetails androidDetails = AndroidNotificationDetails(
      ...
      //icon display in foreground mode
      icon: '@mipmap/launcher_icon',
      color: const Color(0xFF35ADA5),
    );
